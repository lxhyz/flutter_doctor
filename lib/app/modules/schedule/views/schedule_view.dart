  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:SmartRefresher(
        ...
        onLoading: () => controller.refreshLoadScheduleList(),
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ElevatedButton(
                    onPressed: (){
                      controller.getScheduleListData(controller.queryScheduleStatus.value);
                    },
                    child: Text("request"),
                  ),
                  Container(
                    ...
                    child: Container(
                      ...
                      child: ToggleButtons(
                        ...
                        onPressed: (int index) {
                          ...
                          controller.getScheduleListData(index == 1 ? 0 : 1);
                        },
                      ),
                    ),
                  ),
                  ...
                  Column(
                    children: [
                      ...List.generate(controller.scheduleList.length, (index){
                        return Container(
